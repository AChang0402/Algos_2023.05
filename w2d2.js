...
console.log(emptyTree.contains(6))
...
// console.log(emptyTree.containsRecursive(6))

// console.log(threeLevelTree.range())
// console.log(threeLevelTree.range(threeLevelTree.root.left))
// console.log(threeLevelTree.range(threeLevelTree.root.right.left))
// console.log(threeLevelTree.range(threeLevelTree.root.right.right))
