...
class MinHeap {
    ...
    extract() {
        ...
        if (this.heap[0] == null) {
            let currentIndex = 1
            while (this.heap[this.idxOfLeftChild(currentIndex)] != null) {
                if (this.heap[this.idxOfLeftChild(currentIndex)] < this.heap[this.idxOfRightChild(currentIndex)] || this.heap[this.idxOfRightChild(currentIndex)]==null) {
                    this.swap(currentIndex, this.idxOfLeftChild(currentIndex))
                    currentIndex = this.idxOfLeftChild(currentIndex)
                }
                else if ((this.heap[this.idxOfLeftChild(currentIndex)] > this.heap[this.idxOfRightChild(currentIndex)])) {
                    this.swap(currentIndex, this.idxOfRightChild(currentIndex))
...
console.log("extracted: ", MyHeap.extract())
MyHeap.printHorizontalTree();
console.log("extracted: ", MyHeap.extract())
MyHeap.printHorizontalTree();
console.log("extracted: ", MyHeap.extract())
